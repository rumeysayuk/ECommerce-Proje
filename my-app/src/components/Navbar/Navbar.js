            ...
            <Toolbar className={classes.toolbar}>
                {user?.result ? (
                    <div className={classes.profile}>
                        ...
                        <Button variant={"contained"} className={classes.logout} color={"primary"}>Çıkış Yap</Button>
                    </div>
                ) : (
